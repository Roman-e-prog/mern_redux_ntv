...
import {reset, updateDropdownBoerse, getDropdownBoerse} from "../../../features/dropdown/boerseSlice";
...
cursor:pointer;
`;
const DropdownBoerseEdit = () => {
    const dispatch = useDispatch();
    const navigate = useNavigate();
    const { id } = useParams();
    const uniqueId = useId();
    const singleDropdownBoerse = useSelector((state)=>state.dropdownBoerse.singleDropdownBoerse);
    const isLoading = useSelector((state)=>state.dropdownBoerse.isLoading);
    const isError = useSelector((state)=>state.dropdownBoerse.isError);
    const message = useSelector((state)=>state.dropdownBoerse.message);
    ...
    useEffect(()=>{
            if(singleDropdownBoerse){
                setFormdata({...singleDropdownBoerse})
            }
...
const handleVideoChange = (index, e)=>{
    ...
    console.log(lis, themen);
      const onSubmit = (e) => {
        ...
        const updateDropdownBoerseData = {
            formData,
            id:id
        }
        dispatch(updateDropdownBoerse(updateDropdownBoerseData));
      }
  ...
  return (
    ...
    <ToastContainer/>
        <TitleHolder>
            <Title>Update DropdownBörse</Title>
        </TitleHolder>
        <ContentHolder>
...
export default DropdownBoerseEdit