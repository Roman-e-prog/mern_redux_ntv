...
import {reset, updateDropdownWetter, getDropdownWetter} from "../../../features/dropdown/wetterSlice";
...
cursor:pointer;
`;
const DropdownWetterEdit = () => {
    const dispatch = useDispatch();
    const navigate = useNavigate();
    const { id } = useParams();
    const uniqueId = useId();
    const singleDropdownWetter = useSelector((state)=>state.dropdownWetter.singleDropdownWetter);
    const isLoading = useSelector((state)=>state.dropdownWetter.isLoading);
    const isError = useSelector((state)=>state.dropdownWetter.isError);
    const message = useSelector((state)=>state.dropdownWetter.message);
    ...
    useEffect(()=>{
            if(singleDropdownWetter){
                setFormdata({...singleDropdownWetter})
            }
...
const handleVideoChange = (index, e)=>{
    ...
    console.log(lis, themen);
      const onSubmit = (e) => {
        ...
        const updateDropdownWetterData = {
            formData,
            id:id
        }
        dispatch(updateDropdownWetter(updateDropdownWetterData));
      }
  ...
  return (
    ...
    <ToastContainer/>
        <TitleHolder>
            <Title>Update DropdownWetter</Title>
        </TitleHolder>
        <ContentHolder>
...
export default DropdownWetterEdit