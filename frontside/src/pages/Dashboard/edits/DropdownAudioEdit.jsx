...
import {reset, updateDropdownAudio, getDropdownAudio} from "../../../features/dropdown/audioSlice";
...
cursor:pointer;
`;
const DropdownAudioEdit = () => {
    const dispatch = useDispatch();
    const navigate = useNavigate();
    const { id } = useParams();
    const uniqueId = useId();
    const singleDropdownAudio = useSelector((state)=>state.dropdownAudio.singleDropdownAudio);
    ...
    useEffect(()=>{
            if(singleDropdownAudio){
                setFormdata({...singleDropdownAudio})
            }
    },[singleDropdownAudio]);
...
const handleVideoChange = (index, e)=>{
    ...
    console.log(lis, themen);
      const onSubmit = (e) => {
        ...
        const updateDropdownAudioData = {
            formData,
            id:id
        }
        dispatch(updateDropdownAudio(updateDropdownAudioData));
      }
  ...
  return (
    ...
    <ToastContainer/>
        <TitleHolder>
            <Title>Update DropdownAudio</Title>
        </TitleHolder>
        <ContentHolder>
...
export default DropdownAudioEdit