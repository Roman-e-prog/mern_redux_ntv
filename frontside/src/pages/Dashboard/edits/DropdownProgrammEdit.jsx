...
import {reset, updateDropdownProgramm, getDropdownProgramm} from "../../../features/dropdown/programmSlice";
...
cursor:pointer;
`;
const DropdownProgrammEdit = () => {
    const dispatch = useDispatch();
    const navigate = useNavigate();
    const { id } = useParams();
    const uniqueId = useId();
    const singleDropdownProgramm = useSelector((state)=>state.dropdownProgramm.singleDropdownProgramm);
    const isLoading = useSelector((state)=>state.dropdownProgramm.isLoading);
    const isError = useSelector((state)=>state.dropdownProgramm.isError);
    const message = useSelector((state)=>state.dropdownProgramm.message);
    ...
    useEffect(()=>{
        if(isError){
            ...
            dispatch(getDropdownProgramm(id));
            return ()=>{
                dispatch(reset());
            }
    ...
    useEffect(()=>{
            if(singleDropdownProgramm){
                setFormdata({...singleDropdownProgramm})
            }
...
const handleVideoChange = (index, e)=>{
    ...
    console.log(lis, themen);
      const onSubmit = (e) => {
        ...
        const updateDropdownProgrammData = {
            formData,
            id:id
        }
        dispatch(updateDropdownProgramm(updateDropdownProgrammData));
      }
  ...
  return (
    ...
    <ToastContainer/>
        <TitleHolder>
            <Title>Update DropdownProgramm</Title>
        </TitleHolder>
        <ContentHolder>
...
export default DropdownProgrammEdit