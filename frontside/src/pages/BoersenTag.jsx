...
const BoersenTag = () => {
    ...
    useEffect(()=>{
      setFilteredMainNews(allMainNews.filter((item)=>item.ressort === "Börsen Tag"))
      setFilteredInlineNews(allInlineNews.filter((item)=>item.ressort === "Börsen Tag"))
      setFilteredVideos(videos.filter((item)=>item.ressort === "Börsen Tag"))
