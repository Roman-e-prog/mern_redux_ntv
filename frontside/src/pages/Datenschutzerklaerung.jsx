  ...
  return (
    <Container>
      ...
      <h1>Datenschutzerklärung</h1>
            ...
            <h5>Falls Sie nicht möchten, dass Cookies zur Reichweitenmessung auf Ihrem Endgerät gespeichert werden, können Sie dem Einsatz dieser Dateien hier widersprechen:</h5>
            <ul>
            ...
            <h5>Umgang mit Kommentaren und Beiträgen</h5>
            ...
            <h5>Hier finden Sie weitere Informationen zur Datennutzung durch die Google Inc.:</h5>

            <p>https://policies.google.com/privacy/partners?hl=de (Daten, die von Google-Partnern erhoben werden) · https://adssettings.google.de/authenticated (Einstellungen über Werbung, die Ihnen angezeigt wird) · https://policies.google.com/technologies/ads?hl=de (Verwendung von Cookies in Anzeigen)</p>

            <h5>Nutzung von Social-Media-Plugins von Facebook</h5>
            ...
            <p> Sie sich am besten direkt bei Ihrem Versanddienstleister. Ggf. müssen Sie mit ihm auch einen Vertrag zur Auftragsdatenverarbeitung abschließen.</p>
