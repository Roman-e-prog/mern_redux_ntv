...
import { getAdvertise } from '../../features/advertises/advertiseSlice';
...
const AdvertiseArticles = () => {
    ...
    const advertise = useSelector((state)=>state.advertises.advertise);
    const {id} = useParams();
...
export default AdvertiseArticles
