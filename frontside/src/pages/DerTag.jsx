...
const DerTag = () => {
    ...
    useEffect(()=>{
      setFilteredMainNews(allMainNews.filter((item)=>item.ressort === "Der Tag"))
      setFilteredInlineNews(allInlineNews.filter((item)=>item.ressort === "Der Tag"))
      setFilteredVideos(videos.filter((item)=>item.ressort === "Der Tag"))
