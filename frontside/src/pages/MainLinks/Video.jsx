...
const Video = () => {
    ...
    useEffect(()=>{
      setFilteredMainNews(allMainNews.filter((item)=>item.ressort === "Video"))
      setFilteredInlineNews(allInlineNews.filter((item)=>item.ressort === "Video"))
      setFilteredVideos(videos.filter((item)=>item.ressort === "Video"))
