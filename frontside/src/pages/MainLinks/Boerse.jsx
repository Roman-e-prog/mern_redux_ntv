...
const Boerse = () => {
    ...
    useEffect(()=>{
      setFilteredMainNews(allMainNews.filter((item)=>item.ressort === "Börse"))
      setFilteredInlineNews(allInlineNews.filter((item)=>item.ressort === "Börse"))
      setFilteredVideos(videos.filter((item)=>item.ressort === "Börse"))
