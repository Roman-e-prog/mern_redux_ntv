...
const Audio = () => {
    ...
    useEffect(()=>{
      setFilteredMainNews(allMainNews.filter((item)=>item.ressort === "Audio"))
      setFilteredInlineNews(allInlineNews.filter((item)=>item.ressort === "Audio"))
      setFilteredVideos(videos.filter((item)=>item.ressort === "Audio"))
