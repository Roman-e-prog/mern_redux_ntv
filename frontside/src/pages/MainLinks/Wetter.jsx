...
const Wetter = () => {
    ...
    useEffect(()=>{
      setFilteredMainNews(allMainNews.filter((item)=>item.ressort === "Wetter"))
      setFilteredInlineNews(allInlineNews.filter((item)=>item.ressort === "Wetter"))
      setFilteredVideos(videos.filter((item)=>item.ressort === "Wetter"))
