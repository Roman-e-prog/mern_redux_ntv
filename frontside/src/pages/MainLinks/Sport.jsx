...
const Sport = () => {
    ...
    useEffect(()=>{
      setFilteredMainNews(allMainNews.filter((item)=>item.ressort === "Sport"))
      setFilteredInlineNews(allInlineNews.filter((item)=>item.ressort === "Sport"))
      setFilteredVideos(videos.filter((item)=>item.ressort === "Sport"))
